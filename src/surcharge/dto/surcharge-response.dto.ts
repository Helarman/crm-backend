...
export class SurchargeResponseDto {
  @ApiProperty({ example: 'cln3e8xjh000008l49y5r3z6a', description: 'ID надбавки' })
  id: string;
  ...
  @ApiProperty({ example: true, description: 'Активна ли надбавка' })
  isActive: boolean;
  ...
  @ApiProperty({ example: '2023-01-01T00:00:00Z', description: 'Дата обновления' })
  updatedAt: Date;
}